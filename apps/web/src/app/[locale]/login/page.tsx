      ...
      {step === 'email' ? (
        <form onSubmit={handleSendLink} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full cursor-pointer rounded-lg bg-thread px-4 py-2.5 font-medium text-white transition-colors hover:bg-thread/90 disabled:opacity-50"
          >
        ...
        <form onSubmit={handleVerify} className="space-y-4">
          ...
          <button
            ...
            className="w-full cursor-pointer text-sm text-content-secondary hover:text-content"
          >
            {t('useDifferentEmail')}
          </button>
        </form>
